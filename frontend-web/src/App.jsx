...
function ChangePasswordPage() {
  ...
  return (
    <PageShell
      ...
      subtitle="This form validates locally and submits to the API."
    >
      {error && (
      ...
      <form onSubmit={onSubmit} className="max-w-lg space-y-4">
        ...
        <div>
          ...
          <div className="mt-1 text-xs text-slate-500">
            Minimum length: 8 characters (local validation only).
          </div>
        </div>
        ...
        <div>
          ...
          <input
            ...
            className={[
              ...
              mismatch
                ? "border-red-900/60 focus:ring-red-900/30"
                : "border-slate-800 focus:ring-sky-600/30",
            ].join(" ")}
          ...
          />
          {mismatch && (
            <div className="mt-1 text-xs text-red-200">Passwords do not match.</div>
          )}
        </div>
